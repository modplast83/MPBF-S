...
app.use('/api/auth', function (req, res, next) {
    console.log("Intercepted auth API request: ".concat(req.path));
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                app.use(function (err, _req, res, _next) {
                    ...
                    console.error("Error handler caught: ".concat(err.stack || err));
            ...
            case 3:
                ...
                _a.label = 4;
            case 4:
                port = parseInt((process.env.PORT || "5000").toString());
                server.listen(port, "0.0.0.0", function () {
                    (0, vite_1.log)("serving on port ".concat(port));
                }).on('error', function (err) {
                    if (err.code === 'EADDRINUSE') {
                        console.log("Port ".concat(port, " is busy, trying ").concat(port + 1000));
                        var fallbackPort_1 = port + 1000;
                        server.listen(fallbackPort_1, "0.0.0.0", function () {
                            (0, vite_1.log)("serving on port ".concat(fallbackPort_1));
                        });
                    }
                    else {
                        throw err;
