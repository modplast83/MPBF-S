...
function ensureAdminUser() {
    return __awaiter(this, void 0, void 0, function () {
        var adminUser, hashedPassword, adminUser_1, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, auth_utils_1.hashPassword)('admin123')];
                case 2:
                    hashedPassword = _a.sent();
                    adminUser_1 = {
                        id: (0, uuid_1.v4)(), // Generate a UUID for the user ID
                        username: 'admin',
                    ...
                    return [4 /*yield*/, storage_1.storage.upsertUser(adminUser_1)];
                case 3:
                    _a.sent();
                ...
                case 6:
                    error_1 = _a.sent();
                    console.error("Error ensuring admin user:", error_1);
                    return [3 /*break*/, 7];
