...
export const SIDEBAR_ITEMS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "people",
        subItems: [
          { title: "sidebar.enhanced_attendance", path: "/hr/enhanced-attendance" },
          { title: "sidebar.employee_management", path: "/hr/employee-management" },
          { title: "sidebar.employee_ranks", path: "/hr/employee-ranks" },
          { title: "sidebar.overtime_leave", path: "/hr/overtime-leave" },
          { title: "sidebar.geofence_management", path: "/hr/geofences" },
          { title: "sidebar.time_attendance", path: "/hr/time-attendance" },
          { title: "sidebar.employee_of_the_month", path: "/hr/employee-of-month" },
          { title: "sidebar.violation_and_complaint", path: "/hr/violations-complaints" },
          { title: "sidebar.training", path: "/hr/training" },
          { title: "sidebar.certificates", path: "/hr/certificates" },
        ],
      },
      {
        title: "Maintenance",
