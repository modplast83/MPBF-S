          ...
          {expanded ? (
            <div className="flex flex-col items-center w-full space-y-3">
              <div className="bg-white/95 p-3 rounded-2xl shadow-lg ring-1 ring-white/20 backdrop-blur-sm">
                <img src={companyLogo} alt="Modern Plastic Bag Factory" className="h-16 w-16 object-contain" />
              </div>
            ...
            <div className="flex items-center justify-center w-full">
              <div className="bg-white/95 p-2 rounded-xl shadow-lg ring-1 ring-white/20">
                <img src={companyLogo} alt="Modern Plastic Bag Factory" className="h-10 w-10 object-contain" />
              </div>
            </div>
          )}
        </div>
